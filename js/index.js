...
document.addEventListener('DOMContentLoaded', () => { console.log('DOM Ready. Initializing script...'); try { console.log('Setting up constants and variables...'); const CASHIER_KEY = 'P21_ANGEL', CASHIER_NAME = 'Angel'; const API_BASE_URL = '/api'; let subActive = false; const OPEN_KEY = `p21_shift_open_date_${CASHIER_KEY}`; const STEP = 1000;
